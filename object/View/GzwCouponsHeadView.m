...
-(instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        // 网络加载 --- 创建带标题的图片轮播器
        self.cycleScrollView = [SDCycleScrollView cycleScrollViewWithFrame:CGRectMake(0, 0, ViewW, ViewW*0.35) delegate:nil placeholderImage:[UIImage imageNamed:@"unchecked"]];
        self.cycleScrollView.imageURLStringsGroup = @[@"http://www.zycpimg.com/img/banner/1496246400/1496975415112891725.jpg"];
