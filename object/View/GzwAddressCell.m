...
- (void)awakeFromNib {
    ...
    self.three.textColor = [GzwThemeTool subTitleTextTheme];
...
#pragma mark Set
-(void)setModel:(GzwObject *)model
{
    _model = model;
    self.name.text = model.title;
    self.three.text = [NSString stringWithFormat:@"报酬：%@",model.name];
    self.region.text = model.subtitle;
