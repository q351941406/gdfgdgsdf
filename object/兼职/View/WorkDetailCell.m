...
-(void)setModel:(DetailModel *)model
{
    ...
    CGSize sizeCon = [model.content?model.content:@"未填写" boundingRectWithSize:CGSizeMake(labelW, 70) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:    [UIFont systemFontOfSize:14]
} context:nil].size;
    ...
    CGSize sizeReq = [model.require?model.require:@"未填写" boundingRectWithSize:CGSizeMake(labelW, 60) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:    [UIFont systemFontOfSize:14]
} context:nil].size;
